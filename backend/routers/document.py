...
from db.matcher import insert_uploaded_document, get_uploaded_documents, get_document_by_id, CaseEntryMatcher, CaseNotFoundError
...
async def operational_confirm_api(
    ...
    try:
        ...
        #final_confirmation_records = await matcher.insert_operational_confirmation(
        #    executor=executor,
        #    case_id=case_id,
        #    case_ack_no=case_ack_no,
        #    document_statuses_json=parsed_document_statuses, # This is the List[Dict[str,bool]]
        ...
        #return {"success": True, "message": "Operational confirmation recorded successfully.", "record": final_confirmation_records}
