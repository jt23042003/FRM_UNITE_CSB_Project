#!/usr/bin/env python3
"""
Script to create sample templates for testing the template system.
...
def create_sample_templates():
    ...
    # Sample templates with different question types
    sample_templates = [
        {
    ...
    try:
        with psycopg2.connect(**DB_CONNECTION_PARAMS) as conn:
            with conn.cursor() as cur:
                # Clear existing templates and recreate them
                ...
                conn.commit()
                print(f"Successfully created {len(sample_templates)} sample templates!")
