...
const fetchCaseDetails = async () => {
  ...
  if (response.data) {
    const { i4c_data = null, customer_details = null, account_details, acc_num, action_details, status: caseStatus, source_ack_no, created_by, email_body, email_summary } = response.data;
