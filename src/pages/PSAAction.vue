        ...
        <div v-else class="comparison-grid">
          <div class="details-section">
            ...
            <div class="details-row">
              <div class="field-group">
                <label>PAN</label>
                <input type="text" v-model="i4cDetails.pan" :readonly="isReadOnly" />
              </div>
              <div class="field-group">
                <label>Aadhaar</label>
                <input type="text" v-model="i4cDetails.aadhaar" :readonly="isReadOnly" />
              </div>
              <div class="field-group">
                <label>GST</label>
                <input type="text" v-model="i4cDetails.gst" :readonly="isReadOnly" />
              </div>
            </div>
          </div>
...
const fetchCaseDetails = async () => {
  ...
  if (response.data) {
    ...
    const { action_details, status, source_ack_no } = response.data;
    ...
    i4cDetails.value = {
      ...
      pan: i4c_data.pan || 'N/A',
      aadhaar: i4c_data.aadhaar || 'N/A',
      gst: i4c_data.gst || 'N/A'
    };
