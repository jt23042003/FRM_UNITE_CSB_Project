...
const bankDetails = ref({
  ...
  customerId: '', acStatus: '', aqb: '', availBal: '', productCode: '',
  relValue: '', mobVintage: '', addl1: '', addl2: '', addl4: ''
});
const action = ref({
  analysisLOV: '',
  analysisUpdate: '',
...
const saveAction = async () => {
  ...
  // Your API call to save the data would go here
};

const submitAction = async () => {
  console.log('Submitting action:', action.value);
  // Your API call to submit the data would go here
};
</script>
