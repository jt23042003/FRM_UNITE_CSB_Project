  ...
  <div class="pma-container">
    ...
    <div class="step-content">
      <div v-if="currentStep === 1" class="step-panel">
        <h3>Alert - Existing Customer Beneficiary with Transactions</h3>
            ...
            <div v-if="isMMTriggered && reverificationData && !isEmailCaseView" class="reverification-details">
              ...
              <div class="details-row">
                <div class="field-group">
                  ...
                  <input type="text" :value="reverificationData.mobile_number" readonly />
                </div>
                <div class="field-group">
                  <label>Reason Flagged</label>
                  <input type="text" :value="reverificationData.reason_flagged" readonly />
                </div>
                <div class="field-group">
                  <label>Sensitivity Index</label>
                  <input type="text" :value="reverificationData.sensitivity_index" readonly />
                </div>
              </div>
              <div class="details-row">
                <div class="field-group">
                  <label>TSP Name</label>
                  <input type="text" :value="reverificationData.tspname" readonly />
                </div>
                <div class="field-group">
...
const saveAction = async () => {
  ...
  const caseType = 'ECBT'; // Set case_type to ECBT for this component
