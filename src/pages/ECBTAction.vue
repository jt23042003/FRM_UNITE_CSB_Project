        ...
        <div v-else>
            ...
            <div class="details-section beneficiary-table-section">
                ...
                <div class="table-container">
                    ...
                    <tbody>
                      <tr
                        v-for="txn in transactionDetails"
                        :key="txn.txn_ref"
                        :class="{ 'highlight-row': txn.is_bene_match }"
                      >
                        <td>{{ txn.txn_date || '-' }}</td>
                        <td>{{ txn.txn_time || '-' }}</td>
                      ...
                      <tr v-if="!transactionDetails.length">
